...
//            ->add('scheduleDate','datetime', array('widget' => 'single_text', 'date_format' => 'm/d/Y h:i A'))
            ->add('scheduleDate',TextType::class ,array("invalid_date" => "Invalid Effective schedule date  provided. (i.e. 01/01/2099 00:00:00 AM)"))
//            ->add('expirationDate','datetime', array('widget' => 'single_text', 'date_format' => 'm/d/Y h:i A'))
            ->add('expirationDate',TextType::class ,array("invalid_date" => "Invalid Effective expiration date  provided. (i.e. 01/01/2099 00:00:00 AM)"))
